...
- PHP 8 attributes: `#[Route]`, `#[AsEventListener]`, `#[AutoconfigureTag]`. Never `@annotations`.
...
- For compiler passes, events, voters, cache warmers, and semver contracts, see [advanced-patterns.md](advanced-patterns.md)
